"""
Django settings for beelion project.
...
SECRET_KEY = 'django-insecure-t=u=pzpl)n=5d$!gqp=_2xn)68cuko$6=(0d0hu!v0xdq+bkg7'
...
WSGI_APPLICATION = 'beelion.wsgi.application'
